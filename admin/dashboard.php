...
if ($_SESSION['username']) {
    echo '<br><div class="alert alert-success" style="margin-top: -32px;">
		<center><strong>Success! Hello <button class="btn btn-sm btn-primary" style="border-radius:16px;">' . ucfirst($_SESSION['username']) . '</button></strong></center> Welcome to the homepage of Loyal Partners property management system.
		</div><br/>';
}
?>
