                    ...
                    <div class="form-wrap">
                    	...
                    	<div class="tabs-content">
                    		...
                    		<div id="login-tab-content" class="active">
                    			<form class="login-form" action="home.php" method="post"  enctype="multipart/form-data">
                    				...
                    				<button type="submit" class="submit" style="margin: 1em 0;
                                    padding: .2em 3em;
                                    width: auto;
                                    display: block;
                                    background-color: #28A55F;
                                    ...
                                    -webkit-box-shadow: 0px 0px 37px -9px rgba(0,0,0,0.75);
                                    -moz-box-shadow: 0px 0px 37px -9px rgba(0,0,0,0.75);
                                    box-shadow: 0px 0px 37px -9px rgba(0,0,0,0.75);">Login</button>
                    			</form>
